...
src_prepare() {
	...
	epatch_user
	epatch "${FILESDIR}/php-5.5.38-mbstring-oniguruma-6.8.patch" 
...
pkg_postinst() {
	...
	ewarn "This version of PHP 5.5 is not due to receive any further security updates."
	ewarn "Please migrate to 5.6 or later as soon as possible."
	ewarn "PHP 5.5 has been removed from portage tree."
	ewarn
}
